    ...
    <div class="about__section" id="about">
        <div class="column">
            ...
            <p>
                ...
                <a href="<?php echo esc_url( $plugin_data['PluginURI'] ); ?>"><?php echo esc_url( $plugin_data['PluginURI'] ); ?></a>
            </p>
        ...
        <div class="column" id="sponsoring">
            <h2><?php _e( 'Sponsoring', 'ucat-next-story' ); ?> <a href="https://www.patreon.com/elenkadark" class="button">Donate</a></h2>
            <p>If you or your company are using any of my projects, consider supporting me so I can continue my open source work.</p>
            <p>Let me try to sell you the idea of why <a href="https://www.patreon.com/elenkadark">sponsoring</a> would be a good idea.</p>
        ...
        <div class="column" id="comingsoon">
            ...
            <ul>
                <li>Settings Next/Previous links directly on page edit page - In Progress</li>
                <li>Random Post</li>
                <li>Display permanent image</li>
                <li>Navigate on subpages under the main page</li>
            </ul>

            <p>If you have any suggestions I would love to <a href="https://wordpress.org/support/plugin/ucat-next-story/">hear</a> them.</p>
        </div>
    </div>
</div>
